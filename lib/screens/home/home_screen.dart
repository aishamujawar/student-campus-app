                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildFeatureGrid(context, shellController),
                        ],
                      ),
                    ),
                  ),
  ...
  Widget _buildHeader(
    ...
    return Row(
      children: [
        ...
        const Spacer(),
        GestureDetector(
          onTap: () => shellController.changeTab(5),
          child: Row(
            children: [
              Column(
      ...
      child: Row(
        children: [
          ...
          ElevatedButton(
            ...
            onPressed: () => shellController.changeTab(1),
            child: const Text(
              'Get Started',
              style: TextStyle(
                fontSize: 13,
          ...
          children: [
            Expanded(
              child: _HomeFeatureCard(
                ...
                onTap: () => shellController.changeTab(1),
              ),
            ),
            ...
            Expanded(
              child: _HomeFeatureCard(
                ...
                onTap: () => shellController.changeTab(3),
              ),
            ),
          ],
        ),
          ...
          children: [
            Expanded(
              child: _HomeFeatureCard(
                ...
                onTap: () => shellController.changeTab(2),
              ),
            ),
            const SizedBox(width: 14),
            Expanded(
              child: _HomeFeatureCard(
                ...
                onTap: () => shellController.changeTab(4),
              ),
            ),
          ],
        ),
